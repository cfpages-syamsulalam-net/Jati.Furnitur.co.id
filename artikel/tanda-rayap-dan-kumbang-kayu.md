---
article_id: JAT-03-02
title: "Tanda Rayap dan Kumbang Bubuk pada Furnitur"
slug: "tanda-rayap-dan-kumbang-kayu"
...
date_modified: null
parent_topic: JAT-03
primary_intent: "Recognize evidence requiring isolation and professional assessment."
reader_community: "Furnitur.co.id"
reader_address: "Sobat Furnitur.co.id"
final_route: "/artikel/tanda-rayap-dan-kumbang-kayu.html"
...
# Tanda Rayap dan Kumbang Bubuk pada Furnitur

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tanda Rayap dan Kumbang Bubuk pada Furnitur”
...
- **Primary intent:** Recognize evidence requiring isolation and professional assessment.
...
- **Scope boundary:** Owns insect diagnosis; treatment selection belongs to JAT-03-05.
- **Final public route:** `/artikel/tanda-rayap-dan-kumbang-kayu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tanda Rayap dan Kumbang Bubuk pada Furnitur**.
...
- `JAT-03-01` → `/artikel/menilai-ketahanan-alami-jati.html` — Menilai Klaim Ketahanan Alami Kayu Jati
- `JAT-03-03` → `/artikel/jamur-noda-pelapukan-kayu.html` — Jamur, Noda, dan Pelapukan pada Kayu
- `JAT-03-04` → `/artikel/melindungi-jati-dari-cuaca.html` — Melindungi Furnitur Jati dari Hujan dan Matahari
...
- **Tie back to this article:** Keep the explanation specific to “Tanda Rayap dan Kumbang Bubuk pada Furnitur”.
