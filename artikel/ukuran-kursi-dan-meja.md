---
article_id: JAT-08-02
title: "Ukuran Kursi dan Hubungannya dengan Meja"
slug: "ukuran-kursi-dan-meja"
...
date_modified: null
parent_topic: JAT-08
primary_intent: "Check seat, arm, back, and table clearances together."
reader_community: "Furnitur.co.id"
reader_address: "Teman Furnitur.co.id"
final_route: "/artikel/ukuran-kursi-dan-meja.html"
...
# Ukuran Kursi dan Hubungannya dengan Meja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Ukuran Kursi dan Hubungannya dengan Meja”
...
- **Primary intent:** Check seat, arm, back, and table clearances together.
...
- **Scope boundary:** Owns chair-table fit; table specification belongs to JAT-09.
- **Final public route:** `/artikel/ukuran-kursi-dan-meja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Ukuran Kursi dan Hubungannya dengan Meja**.
...
- **Exact Markdown to insert:** `![Ilustrasi Meja Kursi Jati 6 1](/wp-content/uploads/2022/04/Meja-Kursi-Jati-6-1.jpeg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Meja Kursi Jati 6 1` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Ukuran Kursi dan Hubungannya dengan Meja”.
