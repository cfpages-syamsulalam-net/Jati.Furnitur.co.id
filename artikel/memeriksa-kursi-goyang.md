---
article_id: JAT-08-06
title: "Cara Memeriksa Kursi Goyang atau Tidak Rata"
slug: "memeriksa-kursi-goyang"
...
date_modified: null
parent_topic: JAT-08
primary_intent: "Diagnose floor, leg, joint, and frame causes."
reader_community: "Furnitur.co.id"
reader_address: "Teman Furnitur.co.id"
final_route: "/artikel/memeriksa-kursi-goyang.html"
...
# Cara Memeriksa Kursi Goyang atau Tidak Rata

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara Memeriksa Kursi Goyang atau Tidak Rata”
...
- **Primary intent:** Diagnose floor, leg, joint, and frame causes.
...
- **Scope boundary:** Owns chair symptom diagnosis; repair belongs to JAT-14.
- **Final public route:** `/artikel/memeriksa-kursi-goyang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Memeriksa Kursi Goyang atau Tidak Rata**.
...
- **Exact Markdown to insert:** `![Ilustrasi Kursi Jati 4](/wp-content/uploads/2022/04/Kursi-Jati-4.jpeg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Kursi Jati 4` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Cara Memeriksa Kursi Goyang atau Tidak Rata”.
