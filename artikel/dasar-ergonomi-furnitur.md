---
article_id: JAT-07-02
title: "Dasar Ergonomi Kursi, Meja, dan Penyimpanan"
slug: "dasar-ergonomi-furnitur"
...
date_modified: null
parent_topic: JAT-07
primary_intent: "Translate user tasks and body range into design questions."
reader_community: "Furnitur.co.id"
reader_address: "Sobat Furnitur.co.id"
final_route: "/artikel/dasar-ergonomi-furnitur.html"
...
# Dasar Ergonomi Kursi, Meja, dan Penyimpanan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Dasar Ergonomi Kursi, Meja, dan Penyimpanan”
...
- **Primary intent:** Translate user tasks and body range into design questions.
...
- **Scope boundary:** Owns cross-product ergonomics; product detail belongs to JAT-08–JAT-10.
- **Final public route:** `/artikel/dasar-ergonomi-furnitur.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dasar Ergonomi Kursi, Meja, dan Penyimpanan**.
...
- **Exact Markdown to insert:** `![Ilustrasi Meja Kursi Jati 8 1](/wp-content/uploads/2022/04/Meja-Kursi-Jati-8-1.jpeg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Meja Kursi Jati 8 1` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Dasar Ergonomi Kursi, Meja, dan Penyimpanan”.
